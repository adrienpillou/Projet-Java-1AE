...
public class Manager {
	...
	//Listes des différents produits
	...
	public static void main(String[] args) {
		...
		ProduitB smartphone = new ProduitB("Iphone", "Eragny", 495.00f, 25, 10);
		ProduitB montre = new ProduitB("Montre", "Paris", 750.00f, 1, 0);
		...
		ProduitA bracelet = new ProduitA("Bracelet", "Méry sur Oise", 5.00f, 15, Qualité.bas_de_gamme);
		ProduitA pot = new ProduitA("Pot de fleur", "Maurecourt", 30.00f, 10, Qualité.haut_de_gamme);
		...
		inventaireB.ajouterLigne(new ProduitB("Camionette", "L'Isle Adam", 35000.00f, 3, 2));
		
		//Instanciation d'un tableau listant les produits de type A
		Tableau inventaireA = new Tableau("Inventaire des produits de type A", ProduitA.attributs, créerDonnéesTableauA(listeA), TypeProduit.TYPEA) ;
	...
	public static void afficherListeB() {
		System.out.println("\n--LISTE B--");
		for(ProduitB produit:listeB) { //parcourir la listeB
	...
	public static void afficherListeA() {
		System.out.println("\n--LISTE A--");
		for(ProduitA produit:listeA) { //parcourir la listeA
			System.out.println(produit.nom);
		}
	}
